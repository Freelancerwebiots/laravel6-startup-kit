...
<html lang="en">
  <head>
    ...
    <title>ProjectDemo - Activation Mail</title>
              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    <h6 style="font-weight: 600">Verify Email Address </h6>
                    <p>Your Registration Active in ProjectDemo Admin. If this is true, Activate Token number is.</p>
                    <p style="text-align: center">{{$otp}}</p>
                    <p>If you have Already activate Account. you can safely ignore his email.</p>
